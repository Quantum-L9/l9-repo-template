# Deprecation: cryptoxdog/golden-repo

> **DEPRECATED.** Do not use [cryptoxdog/golden-repo](https://github.com/cryptoxdog/golden-repo)
...
Paste the blockquote above at the top of `cryptoxdog/golden-repo` README, then archive the repo.
